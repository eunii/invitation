      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-12 text-center md:text-left">
          <div className="space-y-4">
            <p className="font-label-md text-label-md text-secondary uppercase">When</p>
          ...
          <div className="space-y-4">
            <p className="font-label-md text-label-md text-secondary uppercase">Where</p>
          ...
          <div className="space-y-4">
            <p className="font-label-md text-label-md text-secondary uppercase">The Journey</p>
